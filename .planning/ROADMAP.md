...
### Phase 6: Add Claude Status onto the right end of the Claude usage line
...
- [x] 07-02-PLAN.md — Dual filter in _derive_claude_status (id-dismiss + keyword/regex), escalation re-surface, auto-prune (D-01, D-03, D-04)
...
- [x] 07.1-02-PLAN.md — Auto-prune Risk #1 fix: `fetch_claude_status` `live_ids` retains resolved-but-still-degraded tracked incident ids so a dismissed incident stays muted through resolution; truly-stale dismissals still prune (D-06)
