...
- [ ] 07.1-01-PLAN.md — Resolved derivation + cache contract: GREEN `resolved` hue in `_claude_status_color`, resolved-vs-red branch in `_derive_claude_status` Rule 3 (reusing `_is_suppressed`), widen `_collect_tracked_incidents` to carry resolved incidents + fixture/tests (D-01,D-02,D-03,D-04,D-05,D-06)
